...
// @IonicPage()
@Component({
  selector: 'page-subdesign',
  templateUrl: 'subdesign.html',
  providers: [RetailProvider,CommonProvider]
})
export class SubdesignPage {
...
if(this.supplier == true){
  this.navCtrl.push( ProdetailPage, { proid: product_id , single: JSON.parse(localStorage.getItem('see')),supplier:this.supplier} );
}else {
