...
import { AvrproductdetailsPage } from '../avrproductdetails/avrproductdetails';
...
export class InstockPage {
  ...
  openDesign(product_id){
    ...
    this.navCtrl.push( AvrproductdetailsPage, { filter:{metalcode:product_id['MetalCode']}  , single: JSON.parse(localStorage.getItem('see')) } );
