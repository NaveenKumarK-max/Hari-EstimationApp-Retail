...
// @IonicPage()
@Component({
  selector: 'page-masssearch2',
  templateUrl: 'masssearch2.html',
  providers: [CommonProvider]

})
export class Masssearch2Page {
  ...
  getSearch(ev:any){
    ...
    if(this.page == 'category'){
      this.list = this.searchArr.filter(item => item['name'].toUpperCase().includes(val.toUpperCase()));
    }
